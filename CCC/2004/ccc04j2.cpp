...
// Template by https://github.com/bqi343/cp-notebook/blob/master/Implementations/content/contest/CppIO.h
...
#define far(a, x) for (auto& a: x)

#define sortA(l) sort(all(l))
#define sortB(l) sort(all(l), greater<int>())
